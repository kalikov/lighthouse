...
public class BasicLineParser implements LineParser {
    ...
    public static ProtocolVersion parseProtocolVersion(final String value,
    ...
    @Override
    public ProtocolVersion parseProtocolVersion(final ru.radiomayak.http.util.CharArrayBuffer buffer,
    ...
    // non-javadoc, see interface LineParser
    @Override
    public boolean hasProtocolVersion(final ru.radiomayak.http.util.CharArrayBuffer buffer,
     ...
     */
    @Override
    public RequestLine parseRequestLine(final ru.radiomayak.http.util.CharArrayBuffer buffer,
                                        final ParserCursor cursor) throws ParseException {
    ...
    // non-javadoc, see interface LineParser
    @Override
    public StatusLine parseStatusLine(final ru.radiomayak.http.util.CharArrayBuffer buffer,
                                      final ParserCursor cursor) throws ParseException {
        Args.notNull(buffer, "Char array buffer");
        Args.notNull(cursor, "Parser cursor");
        final int indexFrom = cursor.getPos();
    ...
    // non-javadoc, see interface LineParser
    @Override
    public Header parseHeader(final ru.radiomayak.http.util.CharArrayBuffer buffer)
        throws ParseException {

        // the actual parser code is in the constructor of BufferedHeader
        return new ru.radiomayak.http.message.BufferedHeader(buffer);
    }
     ...
     */
    protected void skipWhitespace(final ru.radiomayak.http.util.CharArrayBuffer buffer, final ParserCursor cursor) {
