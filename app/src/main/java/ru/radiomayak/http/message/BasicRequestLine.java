...
public class BasicRequestLine implements RequestLine, Cloneable, Serializable {
    ...
    public BasicRequestLine(final String method,
        ...
        super();
        this.method = ru.radiomayak.http.util.Args.notNull(method, "Method");
        this.uri = ru.radiomayak.http.util.Args.notNull(uri, "URI");
        this.protoversion = ru.radiomayak.http.util.Args.notNull(version, "Version");
    }
