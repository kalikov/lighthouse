...
public class BasicHeaderValueFormatter implements HeaderValueFormatter {
    ...
    @Override
    public ru.radiomayak.http.util.CharArrayBuffer formatElements(final ru.radiomayak.http.util.CharArrayBuffer charBuffer,
        ...
        if (buffer == null) {
            buffer = new ru.radiomayak.http.util.CharArrayBuffer(len);
        } else {
    ...
    // non-javadoc, see interface HeaderValueFormatter
    @Override
    public ru.radiomayak.http.util.CharArrayBuffer formatHeaderElement(final ru.radiomayak.http.util.CharArrayBuffer charBuffer,
    ...
    // non-javadoc, see interface HeaderValueFormatter
    @Override
    public ru.radiomayak.http.util.CharArrayBuffer formatParameters(final ru.radiomayak.http.util.CharArrayBuffer charBuffer,
    ...
    // non-javadoc, see interface HeaderValueFormatter
    @Override
    public ru.radiomayak.http.util.CharArrayBuffer formatNameValuePair(final ru.radiomayak.http.util.CharArrayBuffer charBuffer,
     ...
     *                  {@code false} to use quotes only when necessary
     */
    protected void doFormatValue(final ru.radiomayak.http.util.CharArrayBuffer buffer,
                                 final String value,
                                 final boolean quote) {
