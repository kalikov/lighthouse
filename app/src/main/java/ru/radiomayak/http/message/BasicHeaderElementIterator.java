...
import ru.radiomayak.http.HeaderElementIterator;
...
public class BasicHeaderElementIterator implements HeaderElementIterator {
    ...
    private ru.radiomayak.http.util.CharArrayBuffer buffer = null;
    ...
    public BasicHeaderElementIterator(
        ...
        this.headerIt = ru.radiomayak.http.util.Args.notNull(headerIterator, "Header iterator");
        this.parser = ru.radiomayak.http.util.Args.notNull(parser, "Parser");
    }
    ...
    private void bufferHeaderValue() {
        ...
        while (this.headerIt.hasNext()) {
            ...
            if (h instanceof FormattedHeader) {
                ...
                if (value != null) {
                    this.buffer = new ru.radiomayak.http.util.CharArrayBuffer(value.length());
