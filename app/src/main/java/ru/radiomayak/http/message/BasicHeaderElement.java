...
public class BasicHeaderElement implements HeaderElement, Cloneable {
    ...
    public BasicHeaderElement(
        ...
        super();
        this.name = ru.radiomayak.http.util.Args.notNull(name, "Name");
        this.value = value;
        if (parameters != null) {
    ...
    public NameValuePair getParameterByName(final String name) {
        ru.radiomayak.http.util.Args.notNull(name, "Name");
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof HeaderElement) {
            ...
            return this.name.equals(that.name)
                && ru.radiomayak.http.util.LangUtils.equals(this.value, that.value)
                && ru.radiomayak.http.util.LangUtils.equals(this.parameters, that.parameters);
        } else {
            return false;
        }
    }
    ...
    @Override
    public int hashCode() {
        int hash = ru.radiomayak.http.util.LangUtils.HASH_SEED;
        hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, this.name);
        hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, this.value);
        for (final NameValuePair parameter : this.parameters) {
            hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, parameter);
        }
        return hash;
    }
