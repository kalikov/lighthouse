...
public class BufferedHeader implements FormattedHeader, Cloneable, Serializable {
     ...
     */
    public BufferedHeader(final ru.radiomayak.http.util.CharArrayBuffer buffer)
        throws ParseException {

        super();
        ru.radiomayak.http.util.Args.notNull(buffer, "Char array buffer");
    ...
    @Override
    public ru.radiomayak.http.util.CharArrayBuffer getBuffer() {
        return this.buffer;
    }
