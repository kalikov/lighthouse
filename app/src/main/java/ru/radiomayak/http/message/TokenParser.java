...
public class TokenParser {
     ...
     *  is not delimited by any character.
     */
    public String parseValue(final ru.radiomayak.http.util.CharArrayBuffer buf, final ParserCursor cursor, final BitSet delimiters) {
        final StringBuilder dst = new StringBuilder();
        boolean whitespace = false;
        while (!cursor.atEnd()) {
            final char current = buf.charAt(cursor.getPos());
     ...
     * @param cursor defines the bounds and current position of the buffer
     */
    public void skipWhiteSpace(final ru.radiomayak.http.util.CharArrayBuffer buf, final ParserCursor cursor) {
     ...
     */
    public void copyContent(final ru.radiomayak.http.util.CharArrayBuffer buf, final ParserCursor cursor, final BitSet delimiters,
     ...
     * @param dst destination buffer
     */
    public void copyUnquotedContent(final ru.radiomayak.http.util.CharArrayBuffer buf, final ParserCursor cursor,
     ...
     * @param dst destination buffer
     */
    public void copyQuotedContent(final ru.radiomayak.http.util.CharArrayBuffer buf, final ParserCursor cursor,
            final StringBuilder dst) {
        if (cursor.atEnd()) {
            return;
        }
