...
public interface LineFormatter {
     ...
     */
    ru.radiomayak.http.util.CharArrayBuffer appendProtocolVersion(ru.radiomayak.http.util.CharArrayBuffer buffer,
     ...
     */
    ru.radiomayak.http.util.CharArrayBuffer formatRequestLine(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                      RequestLine reqline);
     ...
     */
    ru.radiomayak.http.util.CharArrayBuffer formatStatusLine(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                     StatusLine statline);
     ...
     * @throws ParseException        in case of a parse error
     */
    ru.radiomayak.http.util.CharArrayBuffer formatHeader(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                 Header header);
