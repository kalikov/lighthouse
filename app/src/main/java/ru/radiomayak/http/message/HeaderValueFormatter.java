...
public interface HeaderValueFormatter {
     ...
     */
    ru.radiomayak.http.util.CharArrayBuffer formatElements(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                   HeaderElement[] elems,
                                   boolean quote);
     ...
     *          that buffer will be used and returned.
     */
    ru.radiomayak.http.util.CharArrayBuffer formatHeaderElement(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                        HeaderElement elem,
                                        boolean quote);
     ...
     *          that buffer will be used and returned.
     */
    ru.radiomayak.http.util.CharArrayBuffer formatParameters(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                     NameValuePair[] nvps,
                                     boolean quote);
     ...
     *          that buffer will be used and returned.
     */
    ru.radiomayak.http.util.CharArrayBuffer formatNameValuePair(ru.radiomayak.http.util.CharArrayBuffer buffer,
                                        NameValuePair nvp,
                                        boolean quote);
