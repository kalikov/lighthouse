...
public class HeaderGroup implements Cloneable, Serializable {
    ...
    public Header getCondensedHeader(final String name) {
        ...
        if (hdrs.length == 0) {
            ...
            final ru.radiomayak.http.util.CharArrayBuffer valueBuffer = new ru.radiomayak.http.util.CharArrayBuffer(128);
    ...
    public HeaderIterator iterator() {
        return new ru.radiomayak.http.message.BasicListHeaderIterator(this.headers, null);
    }
    ...
    public HeaderIterator iterator(final String name) {
        return new ru.radiomayak.http.message.BasicListHeaderIterator(this.headers, name);
    }
