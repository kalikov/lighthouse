...
public class LaxContentLengthStrategy implements ru.radiomayak.http.entity.ContentLengthStrategy {
    ...
    /**
     * Creates {@code LaxContentLengthStrategy} instance. {@link ru.radiomayak.http.entity.ContentLengthStrategy#IDENTITY}
