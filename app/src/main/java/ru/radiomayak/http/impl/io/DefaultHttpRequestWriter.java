...
/**
 * HTTP request writer that serializes its output to an instance of {@link ru.radiomayak.http.io.SessionOutputBuffer}.
 *
 * @since 4.3
 */
public class DefaultHttpRequestWriter extends AbstractMessageWriter<HttpRequest> {
    ...
    public DefaultHttpRequestWriter(final ru.radiomayak.http.io.SessionOutputBuffer buffer) {
        this(buffer, null);
    }
