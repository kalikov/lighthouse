 ...
 * an instance of {@link ru.radiomayak.http.io.SessionOutputBuffer}.
 *
 * @since 4.0
 */
public abstract class AbstractMessageWriter<T extends HttpMessage> implements ru.radiomayak.http.io.HttpMessageWriter<T> {

    protected final ru.radiomayak.http.io.SessionOutputBuffer sessionBuffer;
    protected final ru.radiomayak.http.util.CharArrayBuffer lineBuf;
    protected final ru.radiomayak.http.message.LineFormatter lineFormatter;
    ...
    public AbstractMessageWriter(
        ...
        super();
        this.sessionBuffer = ru.radiomayak.http.util.Args.notNull(buffer, "Session input buffer");
    ...
    public void write(final T message) throws IOException, HttpException {
        ru.radiomayak.http.util.Args.notNull(message, "HTTP message");
