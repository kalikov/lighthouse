...
import ru.radiomayak.http.ConnectionClosedException;
import ru.radiomayak.http.Header;
import ru.radiomayak.http.HttpConnection;
import ru.radiomayak.http.HttpConnectionMetrics;
...
import ru.radiomayak.http.config.MessageConstraints;
import ru.radiomayak.http.entity.BasicHttpEntity;
...
import ru.radiomayak.http.impl.io.ChunkedInputStream;
import ru.radiomayak.http.impl.io.ChunkedOutputStream;
import ru.radiomayak.http.impl.io.ContentLengthInputStream;
import ru.radiomayak.http.impl.io.ContentLengthOutputStream;
import ru.radiomayak.http.impl.io.EmptyInputStream;
...
import ru.radiomayak.http.util.NetUtils;
...
public class BHttpConnectionBase implements HttpConnection, HttpInetConnection {
    ...
    protected OutputStream createOutputStream(
        ...
        if (len == ContentLengthStrategy.CHUNKED) {
            ...
            return new ru.radiomayak.http.impl.io.IdentityOutputStream(outbuffer);
        } else {
    ...
    protected InputStream createInputStream(
        ...
        if (len == ContentLengthStrategy.CHUNKED) {
            ...
            return new ru.radiomayak.http.impl.io.IdentityInputStream(inbuffer);
        } else if (len == 0L) {
