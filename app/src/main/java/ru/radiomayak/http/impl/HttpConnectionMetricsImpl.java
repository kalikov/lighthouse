...
public class HttpConnectionMetricsImpl implements HttpConnectionMetrics {
    ...
    private final ru.radiomayak.http.io.HttpTransportMetrics inTransportMetric;
    private final ru.radiomayak.http.io.HttpTransportMetrics outTransportMetric;
    ...
    public HttpConnectionMetricsImpl(
            final ru.radiomayak.http.io.HttpTransportMetrics inTransportMetric,
            final ru.radiomayak.http.io.HttpTransportMetrics outTransportMetric) {
        super();
