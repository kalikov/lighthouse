...
public class ContentLengthInputStream extends InputStream {
     ...
     */
    private ru.radiomayak.http.io.SessionInputBuffer in = null;
     ...
     */
    public ContentLengthInputStream(final ru.radiomayak.http.io.SessionInputBuffer in, final long contentLength) {
        super();
    ...
    public int read() throws IOException {
        ...
        if (b == -1) {
            if (pos < contentLength) {
                throw new ru.radiomayak.http.ConnectionClosedException(
