...
public class ContentLengthOutputStream extends OutputStream {
     ...
     */
    private final ru.radiomayak.http.io.SessionOutputBuffer out;
     ...
     * @since 4.0
     */
    public ContentLengthOutputStream(final ru.radiomayak.http.io.SessionOutputBuffer out, final long contentLength) {
        super();
        this.out = ru.radiomayak.http.util.Args.notNull(out, "Session output buffer");
        this.contentLength = ru.radiomayak.http.util.Args.notNegative(contentLength, "Content length");
    }
