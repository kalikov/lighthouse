...
public class StrictContentLengthStrategy implements ru.radiomayak.http.entity.ContentLengthStrategy {
    ...
    /**
     * Creates {@code StrictContentLengthStrategy} instance. {@link ru.radiomayak.http.entity.ContentLengthStrategy#IDENTITY}
