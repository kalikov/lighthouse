...
import ru.radiomayak.http.util.Asserts;
import ru.radiomayak.http.util.ByteArrayBuffer;
 ...
 * <p>
 * {@link #readLine(ru.radiomayak.http.util.CharArrayBuffer)} and {@link #readLine()} methods of this
 * class treat a lone LF as valid line delimiters in addition to CR-LF required
 * by the HTTP specification.
 *
 * @since 4.3
 */
public class SessionInputBufferImpl implements SessionInputBuffer, ru.radiomayak.http.io.BufferInfo {

    private final HttpTransportMetricsImpl metrics;
    private final byte[] buffer;
    private final ByteArrayBuffer linebuffer;
    private final int minChunkLimit;
    private final ru.radiomayak.http.config.MessageConstraints constraints;
    ...
    public SessionInputBufferImpl(
        ...
        this.constraints = constraints != null ? constraints : ru.radiomayak.http.config.MessageConstraints.DEFAULT;
     ...
     */
    @Override
    public int readLine(final ru.radiomayak.http.util.CharArrayBuffer charbuffer) throws IOException {
     ...
     * @exception  IOException  if an I/O error occurs.
     */
    private int lineFromLineBuffer(final ru.radiomayak.http.util.CharArrayBuffer charbuffer)
            throws IOException {
        // discard LF if found
    ...
    private int lineFromReadBuffer(final ru.radiomayak.http.util.CharArrayBuffer charbuffer, final int position)
            throws IOException {
        int pos = position;
    ...
    private int appendDecoded(
            final ru.radiomayak.http.util.CharArrayBuffer charbuffer, final ByteBuffer bbuf) throws IOException {
    ...
    public String readLine() throws IOException {
        final ru.radiomayak.http.util.CharArrayBuffer charbuffer = new ru.radiomayak.http.util.CharArrayBuffer(64);
    ...
    @Override
    public ru.radiomayak.http.io.HttpTransportMetrics getMetrics() {
        return this.metrics;
    }
}
