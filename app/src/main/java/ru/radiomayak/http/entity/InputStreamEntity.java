...
public class InputStreamEntity extends AbstractHttpEntity {
     ...
     * @since 4.3
     */
    public InputStreamEntity(final InputStream instream, final ru.radiomayak.http.entity.ContentType contentType) {
     ...
     * @since 4.2
     */
    public InputStreamEntity(final InputStream instream, final long length, final ru.radiomayak.http.entity.ContentType contentType) {
        super();
