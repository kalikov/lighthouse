...
public class BasicHttpEntity extends AbstractHttpEntity {
    ...
    public InputStream getContent() throws IllegalStateException {
        ru.radiomayak.http.util.Asserts.check(this.content != null, "Content has not been provided");
        return this.content;
    }
    ...
    public boolean isStreaming() {
        return this.content != null && this.content != ru.radiomayak.http.impl.io.EmptyInputStream.INSTANCE;
    }
