...
import ru.radiomayak.http.Consts;
...
import ru.radiomayak.http.util.TextUtils;
...
public final class ContentType implements Serializable {
    ...
    public String toString() {
        final ru.radiomayak.http.util.CharArrayBuffer buf = new ru.radiomayak.http.util.CharArrayBuffer(64);
        buf.append(this.mimeType);
        if (this.params != null) {
            buf.append("; ");
            ru.radiomayak.http.message.BasicHeaderValueFormatter.INSTANCE.formatParameters(buf, this.params, false);
    ...
    public static ContentType parse(
        ...
        final ru.radiomayak.http.util.CharArrayBuffer buf = new ru.radiomayak.http.util.CharArrayBuffer(s.length());
        buf.append(s);
        final ru.radiomayak.http.message.ParserCursor cursor = new ru.radiomayak.http.message.ParserCursor(0, s.length());
        final HeaderElement[] elements = ru.radiomayak.http.message.BasicHeaderValueParser.INSTANCE.parseElements(buf, cursor);
