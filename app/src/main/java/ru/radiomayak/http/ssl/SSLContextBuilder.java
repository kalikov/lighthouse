...
package ru.radiomayak.http.ssl;
...
public class SSLContextBuilder {
    ...
    static class KeyManagerDelegate extends X509ExtendedKeyManager {
        ...
        public Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> getClientAliasMap(
                final String[] keyTypes, final Principal[] issuers) {
            final Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> validAliases = new HashMap<String, ru.radiomayak.http.ssl.PrivateKeyDetails>();
            for (final String keyType: keyTypes) {
                final String[] aliases = this.keyManager.getClientAliases(keyType, issuers);
                if (aliases != null) {
                    for (final String alias: aliases) {
                        validAliases.put(alias,
                                new ru.radiomayak.http.ssl.PrivateKeyDetails(keyType, this.keyManager.getCertificateChain(alias)));
                    }
                }
            }
            return validAliases;
        ...
        public Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> getServerAliasMap(
                final String keyType, final Principal[] issuers) {
            final Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> validAliases = new HashMap<String, ru.radiomayak.http.ssl.PrivateKeyDetails>();
        ...
        public String chooseClientAlias(
            ...
            final Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> validAliases = getClientAliasMap(keyTypes, issuers);
        ...
        public String chooseServerAlias(
            ...
            final Map<String, ru.radiomayak.http.ssl.PrivateKeyDetails> validAliases = getServerAliasMap(keyType, issuers);
            return this.aliasStrategy.chooseAlias(validAliases, socket);
        }
