...
/**
 * Builder for {@link ru.radiomayak.http.protocol.HttpProcessor} instances.
 *
 * @since 4.3
 */
public class HttpProcessorBuilder {
    ...
    public ru.radiomayak.http.protocol.HttpProcessor build() {
        return new ru.radiomayak.http.protocol.ImmutableHttpProcessor(
