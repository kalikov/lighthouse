 ...
 * @since 4.3
 */
@ru.radiomayak.http.annotation.Contract(threading = ru.radiomayak.http.annotation.ThreadingBehavior.SAFE)
public class UriHttpRequestHandlerMapper implements HttpRequestHandlerMapper {
    ...
    protected UriHttpRequestHandlerMapper(final UriPatternMatcher<HttpRequestHandler> matcher) {
        super();
        this.matcher = ru.radiomayak.http.util.Args.notNull(matcher, "Pattern matcher");
    }
    ...
    public void register(final String pattern, final HttpRequestHandler handler) {
        ru.radiomayak.http.util.Args.notNull(pattern, "Pattern");
        ru.radiomayak.http.util.Args.notNull(handler, "Handler");
