...
public final class HttpHost implements Cloneable, Serializable {
    ...
    public int hashCode() {
        ...
        hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, this.lcHostname);
        hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, this.port);
        hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, this.schemeName);
        if (address!=null) {
            hash = ru.radiomayak.http.util.LangUtils.hashCode(hash, address);
        }
        return hash;
    }
