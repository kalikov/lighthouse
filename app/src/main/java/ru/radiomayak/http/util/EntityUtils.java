...
package ru.radiomayak.http.util;
...
public final class EntityUtils {
    ...
    private static String toString(
            ...
            final ru.radiomayak.http.entity.ContentType contentType) throws IOException {
        final InputStream instream = entity.getContent();
        if (instream == null) {
            return null;
        }
        try {
            ...
            if (contentType != null) {
                ...
                if (charset == null) {
                    final ru.radiomayak.http.entity.ContentType defaultContentType = ru.radiomayak.http.entity.ContentType.getByMimeType(contentType.getMimeType());
                    charset = defaultContentType != null ? defaultContentType.getCharset() : null;
                }
            }
            if (charset == null) {
                charset = ru.radiomayak.http.protocol.HTTP.DEF_CONTENT_CHARSET;
            }
    ...
    public static String toString(final HttpEntity entity) throws IOException, ParseException {
        Args.notNull(entity, "Entity");
        return toString(entity, ru.radiomayak.http.entity.ContentType.get(entity));
    }
