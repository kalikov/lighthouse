...
public class PodcastsOpenHelperTest {
    ...
    @Test
    public void shouldUpgradeFromVersion7() {
        Podcast podcastVersion1 = new Podcast(1, "name");
        podcastVersion1.setDescription("description");
        podcastVersion1.setLength(100);
        podcastVersion1.setIcon(new Image("icon_url", 1, 2));
        ...
        Context context = InstrumentationRegistry.getTargetContext();
        PodcastsOpenHelperVersion7 helperVersion7 = new PodcastsOpenHelperVersion7(context);
        try (SQLiteDatabase database = helperVersion7.getWritableDatabase()) {
            ContentValues podcast1 = new ContentValues();
            podcast1.put("id", 1);
            podcast1.put("name", "name");
            podcast1.put("description", "description");
    ...
    public class PodcastsOpenHelperVersion7 extends SQLiteOpenHelper {
        PodcastsOpenHelperVersion7(Context context) {
            super(context, TEST_DATABASE_NAME, null, 7);
        }
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(PodcastsReadableDatabase.PodcastsTable.CREATE_RATING_ORD_INDEX_SQL);
            db.execSQL(PodcastsReadableDatabase.PlayersTable.CREATE_PLAYED_ORD_INDEX_SQL);
        }
